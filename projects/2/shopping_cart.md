...
*   за всяка приложена промоция информация от какъв тип е и колко отстъпка носи (в абсолютна стойност),
*   името на приложения купон, от какъв тип е и колко отстъпка носи (в абсолютна стойност).