...
*   всеки набор от n на брой такива продукта е с намален с x% (например за всеки 3 книги `"Effective C++, 3rd edition"` получавате 30% отстъпка, но 4-тата ще е на пълната си цена, освен ако не вземете още 2);
...
Добавете възможност за изваждане на информация за пазарската количка за това:
